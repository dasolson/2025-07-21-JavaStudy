 ...
 *              => 출력시에도 적용
 *                 int a=10;
 *                 System.out.ptintln(a++); 출력 => 증가
 *                 System.out.ptintln(++a); 증가 => 출력     
 *           -부정연산자 (!) : 부정
 *                          boolean에서 사용이 가능 
 ...
 *                 효율적인 연산 => 왼쪽에 있는 조건이 false면 오른쪽 조건을 수행하지 않는다 
 *                 => 사용 : 범위, 기간 포함여부 확인
 *                              ---- 예약이 가능*                                                                            
 *                          --- 페이징 / 점수
 *                          --- 오라클 : between~AND
...
public class 정리_3 {
	...
	public static void main(String[] args) {
	     ...
	     *   <=====================downCasting
	     *   숫자 관련만 가능 (boolean 은 제외)
	     *   큰데이터형 = 작은 데이터형 => 자동으로 변경
	     *   
	     *   double d=10
	     *            -- 10.0
	     *   int i='A'
