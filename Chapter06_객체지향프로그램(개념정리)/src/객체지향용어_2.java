 ...
 *                  : 같은 폴더까지만 접근이 가능
 *            3) protected
 *                  : 같은 폴더까지만 접근이 가능, 다른 폴더인 경우에 상속이 있어야 접근 가능
 *            4) public
 *                  : 모든 클래스에 접근이 가능
 *                  
 *              ---------------------------------------------------------
 ...
 *       2-1. 제어어
 *       
 *            1) final : 종단 => 종단 클래스 => public final class String
 *                                          public final class Math
 *                                          
 *            2) static : 정적=> 공유 / 공통으로 사용
 *                 public static int a;
 *                 public static void display(){}
 *                 
 *            3) abstract : 클래스 종류 => 추상클래스 / 인터페이스
 *                          기능은 동일 => 구현이 다른 경우
 *                 class/method
