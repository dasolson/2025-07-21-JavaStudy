...
/*
 *     1. 순서를 가지고 있다(인덱스 번호 자동 부여) => 배열 기반 0번 부터 시작
 *     2. 저장된 데이터 중복 허용
 *     3. CRUD(메모리 상) 주로 사용
...
public class ArrayList_1 {
	...
	public static void main(String[] args) {
		...
		//Vector list=new Vector(); //가능
		//LinkedList list=new LinkedList(); // 가능
		// 단점 => 모든 데이터형을 추가 할 수 있다 => Object
		// 추가 => add()
		list.add("홍길동"); // 인덱스 번호 자동으로 0번
		list.add("심청이"); // 1번 => 2번
		list.add("박문수"); // 2번 => 3번
		list.add(1, "이순신"); // 1번 => 속도가 느려진다
		// 무조건 => 0번 부터 순차적으로 인덱스번호 부여
		//         ------------ 반복문 사용이 편리
