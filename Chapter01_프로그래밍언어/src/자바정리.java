 ...
 *               => 운영체제 호환성이 좋다
 *        ㅣ 컴파일 내용이 다르다 : 해당 운영체제에서 컴파일을 다시 한다
 *  5page
 *    자바로 제작이 가능
 *    -------------
 *    1) 웹 개발 : JSP ***
 ...
 *    ㅣ
 *     - src
 *       ㅣ - .java => 클래스명과 동일한 파일명
 *           class A => A.java
 *            ** 한 파일안에 여러개의 클래스 제작 가능
 *            ---------
 *            class A
 *            class B
 *            ---------  A. java / B.java 둘다 가능
