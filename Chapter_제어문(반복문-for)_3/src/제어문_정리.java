 ...
 *                        아이디 중복체크, 검색, 유효성 검사
 *                      
 *             선택 조건문 : ture / false를 나눠서 작업하는 방식
 *               if(조건문)
 *               {
 *                  조건이 true => 수행
 *                  아이디가 입력된 경우
 ...
 *                  --- 해당 데이터가 없는 경우 : else
 *                  
 *             다중 조건문 (사용빈도가 낮다 : 웹 개발에 잘 사용하지 않음, 보통 앱에서 많이 사용) 
 *               => 선택문(Switch)  
 *               => DECODE / CASE => 오라클에서 사용 
 *                  ------   ---- switch
 *                  다중조건문
 *               형식)
 *                    if(조건문)
...
public class 제어문_정리 {
	...
	public static void main(String[] args) {
		...
		cal1.set(Calendar.MONTH,month-1); // month => 0번부터 시작
